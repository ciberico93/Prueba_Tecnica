...
namespace WebAPI_PruebaTecnica.Context;
...
public partial class DbcrudcoreContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCargo).HasName("PK__CARGO__6C985625293063C4");
        ...
        {
            entity.HasKey(e => e.IdEmpleado).HasName("PK__EMPLEADO__CE6D8B9E3BA6BFC8");
